# SKILL.md — Skill portable para video-intake-knowledge (Claude Code)
> Esta skill es portable y funciona en Claude Code y otros entornos compatibles con SKILL.md.
...
Para Claude Code: no hay integración nativa de memoria. Exportar a Markdown/JSON.
...
# Host
export VITK_HOST_TYPE=claude_code
```
